...
import org.iii.ideas.appcross.AppCrossReaderWnd;
import org.iii.ideas.appcross.viewpager.ViewPager;
import org.iii.ideas.appcross.viewpager.VerticalViewPager;

import frame.common.Logs;
...
public class PageReader extends RelativeLayout
{
	...
	private void setCurrentPosition()
	{
		...
		if (null != AppCrossReaderWnd.allWebPage)
		{
			AppCrossReaderWnd.allWebPage.get(mnCurrentChapter).get(mnCurrentPage).extWebView.setCurrentView(true);
			AppCrossReaderWnd.allWebPage.get(nOldChapter).get(nOldPage).extWebView.setCurrentView(false);
		}
		AppCrossApplication.getInteractiveHandler().removeAllMedia();
	}
